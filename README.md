...
- Python 3.13 / Django 5.2 LTS / DRF 3.16
...
│   ├── settings/      # Modular settings (base, cors, celery, caches, etc.)
...
│   └── tasks.py       # ResilientTask, task_on_commit
│
└── users/             # Example app (demonstrates all patterns)
    ...
    ├── tasks.py       # send_welcome_email (ResilientTask example)
